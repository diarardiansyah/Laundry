...
$h = mysqli_query($koneksi,"SELECT * FROM  tbl_pewangi WHERE id_pewangi = $nama_pewangi");
$harga_pewangi = mysqli_fetch_assoc($h);

//menghitung harga laundry
$total_harga = $berat*$harga_layanan['harga_layanan']+$harga_pewangi['harga_pewangi'];

//input data ke database
mysqli_query($koneksi, "INSERT INTO tbl_transaksi VALUES('','$tgl_hari_ini', '$nama_pelanggan', '$jenis_layanan', '$nama_pewangi', '$berat', '$total_harga', '$tgl_selesai_transaksi', '$status')");
